...
var marginitem=0
  ...
  $.flexslider = function(el, options) {
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      if (!slider.vars.animationLoop && target !== slider.currentSlide) {
        ...
        var $container = $($(slider[0]).find('ul>li')[slider.currentSlide + 1]);

       if(!$container.hasClass(options.itemBannerShowClass)){
           if ($container.find(options.bannerSelector).length != 0){
               $container.addClass(options.itemBannerShowClass);
               return true;
           }
       }
        $container.removeClass(options.itemBannerShowClass);
            ...
            posCalc = (function() {
              if (carousel) {
                ...
                slider.newSlides.each(function(index) {
                  ...
                  if(index < offset) offsetWidth += imgWidth + marginitem;
                ...
                switch (special) {
                  ...
                  case "jumpEnd": return (reverse) ? startWidth : endWidth + slider.count*marginitem  ;
                  case "jumpStart": return (reverse) ? endWidth : startWidth +marginitem;
  ...
  $.flexslider.defaults = {
    ...
    removed: function(){},           //{NEW} Callback: function(slider) - Fires after a slide is removed
      ...
      // Added by Pirog (custom banner settings)
